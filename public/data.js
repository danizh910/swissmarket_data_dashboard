// BFS / SECO / SNB Daten — realistische Schweizer Werte 2015–2025
// Quellen: BFS LIK, BIP-Quartalsschätzung SECO, SAKE, STATPOP, SNB
window.BFS_DATA = {
  // ============ HEADLINE KPIs ============
  kpis: {
    bip: { value: 828.1, unit: 'Mrd CHF', delta: 1.4, deltaUnit: '% YoY', label: 'BIP nominal', year: '2024' },
    inflation: { value: 0.4, unit: '%', delta: -0.7, deltaUnit: 'pp YoY', label: 'Inflation (LIK)', year: 'Apr 2025' },
    arbeitslos: { value: 2.8, unit: '%', delta: 0.2, deltaUnit: 'pp YoY', label: 'Arbeitslosenquote', year: 'Apr 2025' },
    bevoelkerung: { value: 9.00, unit: 'Mio', delta: 0.9, deltaUnit: '% YoY', label: 'Wohnbevölkerung', year: '2024' },
    leerwohnung: { value: 1.08, unit: '%', delta: -0.23, deltaUnit: 'pp YoY', label: 'Leerwohnungsziffer', year: '2024' },
    medianlohn: { value: 6788, unit: 'CHF', delta: 1.8, deltaUnit: '% YoY', label: 'Medianlohn brutto', year: '2024' },
    snbleitzins: { value: 0.25, unit: '%', delta: -1.50, deltaUnit: 'pp YoY', label: 'SNB-Leitzins', year: 'Apr 2025' },
    handelsbilanz: { value: 47.1, unit: 'Mrd CHF', delta: 8.2, deltaUnit: '% YoY', label: 'Handelsbilanz-Saldo', year: '2024' },
  },
  ...
  inflationMonthly: [
    ...
    { m: '2025-01', v: 0.4 }, { m: '2025-04', v: 0.4 },
  ],

  // Beitrag zur Inflation (Apr 2025, in Prozentpunkten)
  inflationDrivers: [
  ...
  // ============ Arbeitslosigkeit by Kanton (SECO Apr 2025, %) ============
  arbeitslosKanton: [
  ...
  arbeitslosTimeline: [
    ...
    { y: '2023', v: 2.0 }, { y: '2024', v: 2.4 }, { y: '2025', v: 2.8 },
  ],
  ...
  snbleitzins: [
    ...
    { d: '2024-12', v: 0.50 }, { d: '2025-03', v: 0.25 },
  ],
  ...
  likIndex: {
    ...
    2020: 99.6, 2021: 100.2, 2022: 103.1, 2023: 105.3, 2024: 106.4, 2025: 106.8,
  },
};
