...
export async function getAllSubscriptions(sql) {
  return sql`SELECT endpoint, auth, p256dh FROM push_subscriptions`;
}

export async function deleteSubscription(sql, endpoint) {
